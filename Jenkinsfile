pipeline {
    environment {
      ...
      namespace = "${env.branchname == 'develop' ? 'sme-serap-acomp-dev' : env.branchname == 'release' ? 'sme-serap-acomp-hom' : env.branchname == 'release-r2' ? 'sme-serap-acomp-hom2' : 'sme-serap-acompanhamento' }" 
    }
